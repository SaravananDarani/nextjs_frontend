...
const colume = () => {
    ...
    const { columeUrl } = Constants.routerUrl;
    ...
    const handleAdd = () => {
        let dataJson = state
        const req = { data: dataJson, url: IndexServices.MasterServices.columeUrl }
    ...
    const handleUpdate = () => {
        ...
        const req = {
            data: dataJson,
            url: IndexServices.MasterServices.columeUrl
        }
    ...
    const getPosts = async () => {
        var db = {
            dataId: { id: id },
            url: `${IndexServices.MasterServices.columeUrl}/getid`,
        }
